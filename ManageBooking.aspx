<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageBooking.aspx.cs" Inherits="WebApplication6.ManageBooking" %>
                ...
                <table>
                    ...
                    <asp:GridView ID="BookingGridView" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <ItemTemplate>
                                <asp:Button ID="BookingRoomView" runat="server" Text="DelteBooking" CommandName="DeleteRoom" CommandArgument='<%# Eval("booking_id") %>' OnClick="DeleteRoom" />
                            </ItemTemplate>
                        </asp:TemplateField>
