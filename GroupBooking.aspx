<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupBooking.aspx.cs" Inherits="WebApplication6.WebForm7" %>
            ...
            <div class="left-section">
               ...
               <table>
                ...
                <div class="form-group">
                    <asp:TextBox ID="hid" runat="server" placeholder="Enter Hotel Id"></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:TextBox ID="GroupName" runat="server" placeholder="Enter Group Name"></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:TextBox ID="P" runat="server" placeholder="Enter NoofPeople"></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:Button ID="RegisterButton" runat="server" OnClick="DoGroupBook" Text="Confirm" />
                </div>
